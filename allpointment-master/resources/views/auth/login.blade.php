  ...
  <div class="auth-inner py-2">
    ...
    <div class="card mb-0">
      <div class="card-body">
        ...
        <h4 class="card-title mb-1">{{trans('Welcome  to All Pointment ! 👋')}}</h4>
        <p class="card-text mb-2">{{trans('Please sign-in to your account and start the adventure')}}</p>

        <form class="auth-login-form mt-2" method="POST" action="{{ route('login') }}">
          @csrf
          <div class="form-group">
            <label for="login-email" class="form-label">{{trans('Email')}}</label>
          ...
          <button type="submit" class="btn btn-primary btn-block" tabindex="4">{{trans('Sign in')}}</button>
        </form>
